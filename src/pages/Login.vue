		...
		<div class="tw-flex tw-flex-col tw-items-center tw-justify-center tw-h-4/5 tw-w-full">
			...
			>
				<q-form @submit="onSubmit" @reset="onReset">
					<div>
						<label id="email" class="tw-text-sm tw-font-medium tw-leading-none tw-text-gray-800">Email</label>
						<q-input
							v-model="username"
							type="text"
					...
					<div class="tw-mt-6 tw-w-full">
						<label for="pass" class="tw-text-sm tw-font-medium tw-leading-none tw-text-gray-800">Password</label>
						<q-input
							v-model="password"
							type="password"
							input-class="tw-bg-gray-200 tw-border tw-rounded tw-text-xs tw-font-medium tw-leading-none tw-text-gray-800 tw-py-3 tw-w-full tw-pl-3 tw-mt-2"
